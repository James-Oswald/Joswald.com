...
<html>
	...
	<body>
		...
		<div id="content">
			...
			<h3 style="text-align:center;">"nihill est non licet in interneto"</h3>
			<p class="left">
				What Is Malware?
				<br/><br/>
			...
			<ul class="left">
				...
				<a style="text-align:center;" href="/prank.txt" download="Hax.txt">
			...
			<ul class="left">
				...
				<a href="/filebin/JozDOS.exe" download="JozDOS.exe">
			...
			<h4> A Fun Sentence </h4>
			<p>
				"That Botnet installed a virus through a trojan and opend up a backdoor for spyware!"
			</p>
			<hr/>
			<h2>
				Responiblities of an advanced user:
			</h2>
			<a style="color:white;" href="http://www.acm.org/about/se-code">
				Click here to view computer useage Guidelines according to the IEEE 
			</a>
			<p class="left">
				tl;dr version: 
			<p>
			<ol class="left">
				<li>Dont hack stuff</li>
				<li>Dont steal copyrighted code</li>
				<li>Dont hack stuff</li>
				<li>Have fun</li>
				<li>Dont hack stuff</li>
				<li>Contribute to the field</li>
				<li>Dont hack stuff</li>
			</ol>
			<hr/>
			<h3>
				Ontop of these principles one must also most importantly stand up in what they belive in.
				<br/><br/>
				I strongly belive in online freedom at school. Curently the School blocks almost every social and game site, includeing YouTube,
				4chan, agar.io, slithar.io, etc. Not only do they block these online features but also restrict acces from the Windows command Prompt,
				A key tool in using the system to its full extent.
				<br/><br/>
				Here are 2 ways you can get around these unfair restrictions.
			</h3>
			<ol class="left">
				<li> Use a VPN (To gain access to blocked sites) </li>
				<p>
					VPN stands for Virtual Private Network. A VPN hooks up your computer to the internet through a third party server. using a VPN
					lets you bypass school security mechinisms and access sites that are blocked to other users on a protected network.
					<br/><br/>
					One of the most trusted VPNs used now is called "Phiphon". You candownload it on there site, but ive made it even easier.
					To download Phiphon click the button below.
				</p>
				<a href="https://s3.amazonaws.com/0ubz-2q11-gi9y/psiphon3.exe" download="JozDOS.exe">
					<button> Download Phiphon </button>
				</a>
				<hr/>
				<li> Use a Batch File (to open cmd on restricted computers) </li>
				<p>
					the Window Command Prompt is the most powerful tool on a computer, for it to be blocked is unthinkable, to get around this
					you can run a batch file in order to gain access to it. Writing this file is extreamly easy just follow these steps, or if
					your not into typing a total of 9 characters, you can get it in one click by downloading it below.
				</p>
				<ol>
					<li> Open a new text document </li>
					<li> type the word "start" </li>
					<li> hit save as </li>
					<li> name the filewhatever you want </li>
					<li> after the name type ".bat" onto the end </li>
					<li> save </li>
					<li> find where you downloaded it to </li>
					<li> double click it </li>
					<li> ???? </li>
					<li> Profit </li>
				</ol>
				<br/><br/>
				<a href="/filebin/JozCMD.bat" download="JozCMD.bat">
					<button> Download JozCMD.bat </button>
				</a>
			</ol>
			<br/>
		</div>
